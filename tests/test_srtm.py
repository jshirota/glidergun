...
def dem():
    return grid("./data/n55_e008_1arc_v3.bil")
...
def test_save_bil(dem):
    save(dem, "test_grid.bil")


def test_save_bt(dem):
    save(dem, "test_grid.bt")


def test_save_img(dem):
    save(dem, "test_grid.img")


def test_save_tif(dem):
    save(dem, "test_grid.tif")


def test_save_jpg(dem):
    save(dem, "test_grid.jpg", strict=False)


def test_save_png(dem):
