...
def test_read():
    ...
    assert pytest.approx(dem.extent[0]) == -1994991
    assert pytest.approx(dem.extent[1]) == 460761
    assert pytest.approx(dem.extent[2]) == -1954991
    assert pytest.approx(dem.extent[3]) == 484761
